...
type Querier interface {
	...
	CreateCollectionWithPolicy(ctx context.Context, arg CreateCollectionWithPolicyParams) error
	...
	DeleteUserIfNotLastAdmin(ctx context.Context, arg DeleteUserIfNotLastAdminParams) (sql.Result, error)
	...
	ListCollectionVaultEntryNames(ctx context.Context, collectionID sql.NullString) ([]ListCollectionVaultEntryNamesRow, error)
	...
	ListLoginAttemptEmailIdentitiesForCanonicalMigration(ctx context.Context) ([]ListLoginAttemptEmailIdentitiesForCanonicalMigrationRow, error)
	...
	ListPersonalVaultEntryNames(ctx context.Context, userID string) ([]ListPersonalVaultEntryNamesRow, error)
	...
	ListUsersWithEntryCount(ctx context.Context, privateIngress interface{}) ([]ListUsersWithEntryCountRow, error)
	...
	MarkInvitationRedeemedIfPending(ctx context.Context, arg MarkInvitationRedeemedIfPendingParams) (sql.Result, error)
	...
	SetInitialPasswordHash(ctx context.Context, arg SetInitialPasswordHashParams) (sql.Result, error)
	...
	UpdateLoginAttemptEmailForCanonicalMigration(ctx context.Context, arg UpdateLoginAttemptEmailForCanonicalMigrationParams) error
	...
	UserHasProtectedCollectionImpact(ctx context.Context, userID string) (bool, error)
}
