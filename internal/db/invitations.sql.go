...
const markInvitationRedeemedIfPending = `-- name: MarkInvitationRedeemedIfPending :execresult
UPDATE invitations
...
type MarkInvitationRedeemedIfPendingParams struct {
	RedeemedBy sql.NullString `json:"redeemed_by"`
	ID         string         `json:"id"`
	CodeHash   string         `json:"code_hash"`
}

func (q *Queries) MarkInvitationRedeemedIfPending(ctx context.Context, arg MarkInvitationRedeemedIfPendingParams) (sql.Result, error) {
	return q.db.ExecContext(ctx, markInvitationRedeemedIfPending, arg.RedeemedBy, arg.ID, arg.CodeHash)
}
