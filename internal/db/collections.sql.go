...
type CountAccessibleVaultEntriesParams struct {
	...
	PrivateIngress interface{} `json:"private_ingress"`
...
const createCollectionWithPolicy = `-- name: CreateCollectionWithPolicy :exec
INSERT INTO collections (id, name, description, created_by, private_access_policy)
VALUES (?, ?, ?, ?, ?)
`

type CreateCollectionWithPolicyParams struct {
	ID                  string         `json:"id"`
	Name                string         `json:"name"`
	Description         string         `json:"description"`
	CreatedBy           sql.NullString `json:"created_by"`
...
func (q *Queries) CreateCollectionWithPolicy(ctx context.Context, arg CreateCollectionWithPolicyParams) error {
	_, err := q.db.ExecContext(ctx, createCollectionWithPolicy,
		arg.ID,
		arg.Name,
		arg.Description,
		arg.CreatedBy,
		arg.PrivateAccessPolicy,
	)
	return err
}
...
func (q *Queries) ListAccessibleVaultEntriesWithSecrets(ctx context.Context, arg ListAccessibleVaultEntriesWithSecretsParams) ([]ListAccessibleVaultEntriesWithSecretsRow, error) {
	rows, err := q.db.QueryContext(ctx, listAccessibleVaultEntriesWithSecrets,
		arg.ID,
		arg.UserID,
		arg.UserID_2,
		arg.PrivateIngress,
...
func (q *Queries) ListAccessibleVaultEntryNames(ctx context.Context, arg ListAccessibleVaultEntryNamesParams) ([]string, error) {
	rows, err := q.db.QueryContext(ctx, listAccessibleVaultEntryNames, arg.UserID, arg.UserID_2, arg.PrivateIngress)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) SetVaultEntryCollection(ctx context.Context, arg SetVaultEntryCollectionParams) error {
	_, err := q.db.ExecContext(ctx, setVaultEntryCollection, arg.CollectionID, arg.NameBidx, arg.ID)
	return err
}
...
SET name = ?1,
    description = ?2,
    private_access_policy = COALESCE(?3, private_access_policy),
